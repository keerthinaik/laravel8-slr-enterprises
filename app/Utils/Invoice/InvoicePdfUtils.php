...
class InvoicePdfUtils
{
    public static function createPage(Fpdf $pdf, Invoice $invoice)
    {
        ...
        $pdf->AddPage();
        //horizantal lines
        $pdf->Line(0, 148.5, 210, 148.5);//->Center line
        ...
        $pdf->SetFont('Arial','',9);
        $pdf->cell(135,3,'*goods once sold cannot be taken back or exchanged (Original Copy)',0,0,'L');
        $pdf->SetFont('Arial','B',10);
        $pdf->cell(75,3,'FOR SLR Enterprises',0,1,'C');
        $pdf->cell(210,7.5,'',0,1,'C');

        // duplicate copy
        $pdf->Line(0, 166, 210, 166);
        $pdf->Line(130, 251.5, 210, 251.5);
        $pdf->Line(0, 256.5, 210, 256.5);
        $pdf->Line(130, 261.5, 210, 261.5);
        $pdf->Line(130, 266.5, 210, 266.5);
        $pdf->Line(130, 271.5, 210, 271.5);
        $pdf->Line(0, 290, 210, 290);

        //vertical lines
        $pdf->Line(15, 186.5, 15, 246.5);
        $pdf->Line(77, 186.5, 77, 246.5);
        $pdf->Line(100, 186.5, 100, 246.5);
        $pdf->Line(115, 186.5, 115, 246.5);
        $pdf->Line(130, 186.5, 130, 290);
        $pdf->Line(150, 186.5, 150, 246.5);
        $pdf->Line(167.5, 186.5, 167.5, 246.5);
        $pdf->Line(185, 186.5, 185, 266.5);

        //rectangle containers
        $pdf->Rect(0, 186.5, 210, 10);
        $pdf->Rect(0, 196.5, 210, 50);
        ...
        $pdf->cell(210,15,'',0,1,'L');
        $pdf->SetFont('Arial','',9);
        $pdf->cell(135,3,'*goods once sold cannot be taken back or exchanged (Duplicate Copy)',0,0,'L');
        $pdf->SetFont('Arial','B',10);
        $pdf->cell(75,3,'FOR SLR Enterprises',0,1,'C');
        $pdf->cell(210,7.5,'',0,1,'C');
    }
